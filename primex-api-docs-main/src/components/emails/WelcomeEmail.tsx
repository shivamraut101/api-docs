...
export const WelcomeEmail: React.FC<WelcomeEmailProps> = ({
  ...
  >
    ...
    >
      ...
      {companyName && (
        <p style={{ fontSize: "16px", lineHeight: "24px", marginBottom: "24px" }}>
          Welcome to the Primexmeta B2B portal. Your account for <strong>{companyName}</strong> has
          been successfully configured.
        </p>
      )}

      <p style={{ fontSize: "16px", lineHeight: "24px", marginBottom: "24px" }}>
        Your account for the Primexmeta API Documentation portal has been created. You can now log
        in using the temporary credentials below.
      </p>
      ...
      <p style={{ fontSize: "14px", lineHeight: "20px", color: "#6b7280", fontStyle: "italic" }}>
        Note: You will be required to change your password immediately after your first login for
        security reasons.
      </p>
